...
public class Wait {
    public static void main(String[] args) throws InterruptedException {
        // Implicit wait: đợi 3 giây rồi hãy báo lỗi nha mạy, tui 2 giây đã xuất hiện rồi nha
        /*
         ...
         * 👉 Thực tế, nhiều dự án kết hợp cả hai: đặt Implicit Wait ngắn (3–5 giây) để xử lý độ trễ chung, và dùng Explicit Wait cho các tình huống đặc biệt.
         *
         * ✅ Điểm hay
         * Implicit Wait
